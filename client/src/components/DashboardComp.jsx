...
function DashboardComp() {
    ...
    const [lastMonthCommments, setLastMonthComments] = useState(0)
        ...
        <div className="flex-wrap flex gap-4 justify-center">
            ...
            rounded-md shadow-md">
                <div className="flex justify-between">
                    <div className="">
                        <h3 className="text-gray-500 text-md uppercases">Total Users</h3>
            ...
            rounded-md shadow-md">
                <div className="flex justify-between">
                    <div className="">
                        <h3 className="text-gray-500 text-md uppercases">Total Comments</h3>
            ...
            rounded-md shadow-md">
                <div className="flex justify-between">
                    <div className="">
                        <h3 className="text-gray-500 text-md uppercases">Total Posts</h3>
